        ...
        <div class="col-md-12">
            <div class="">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php 
                        $news = fuel_model('exam_time_table', array('where' => array('published' => 'yes')));
                        $id = 1;
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('assets/exam_time_table/' . $item['pdf']); ?>" target="_blank">
                        ...
                        ?>
                            <tr>
                                <td colspan="5" class="text-center">No Exam Time Table available.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
