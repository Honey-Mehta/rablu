      ...
      <div class="panel-heading" >
         <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#bs-collapse" href="#two" class="expand">
             <i class="glyphicon glyphicon-list"></i> Registration <div class="right-arrow pull-right">+</div>
            </a>
         </h4>
      </div>
    ...
    <div class="notice-grid">
	 		...
	 		<div class=" bg_note">
				...
				<?php $notification = fuel_model('notification', array('limit'=>'5','where'=> array('name'=>'Registration'))); ?>
			...
			<a href="<?php echo base_url('notification/category/registration');?>" class="list-more">Read More</a>
