...
class Exam_time_table_model extends Base_module_model
{

	public $required = array('heading');
	
	public $record_class = 'Exam_time_table_model_item';
	

	function __construct()
	{
		parent::__construct('exam_time_table'); // table name
...
class Exam_time_model_item extends Base_module_record
{
