...
class Fuel_assets_model extends CI_Model {
	...
	public function form_fields($values = array())
	{
		...
		$fields['userfile'] = array('label' => lang('form_label_file'), 'type' => 'file', 'class' => 'multifile_removed', 'accept' => $accepts); // key is userfile because that is what CI looks for in Upload Class
