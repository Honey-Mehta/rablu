...
class Result_model extends Base_module_model
{

	public $required = array('heading');
	
	public $record_class = 'Result_model_item';
	

	function __construct()
	{
		parent::__construct('result'); // table name
...
class Result_model_item extends Base_module_record
{
